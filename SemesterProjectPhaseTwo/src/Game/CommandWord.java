...
public enum CommandWord { // enum er en blanding af en klasse og et array, den definerer en type med en identifier og hvilke værdier der skal ligge i den
    GO("go"), QUIT("quit"), HELP("help"), UNKNOWN("?"), INSPECT("inspect"), TAKE("take"), USE("use"), TALK("talk"), DROP("drop"), CRAFT("craft"), SHOW("show"), MISSION("mission"), SAVE("save"); //her ses de førnævnte værdier
