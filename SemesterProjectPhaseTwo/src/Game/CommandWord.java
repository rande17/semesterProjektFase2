...
public enum CommandWord { //enum is a mix of a class and a array, It define the type with a indentifier and what value that need to be in it
    //her ses de førnævnte værdier
    GO("go"), QUIT("quit"), HELP("help"), UNKNOWN("?"), INSPECT("inspect"), TAKE("take"), USE("use"), TALK("talk"), DROP("drop"), CRAFT("craft"), SHOW("show"), MISSION("mission"), SAVE("save"), LOAD("load"), WIN("win"), LOSE("lose"), ESCAPE("escape");
